...
#define SPORT_PIN FrSkySportSingleWireSerial::SOFT_SERIAL_PIN_3 //frsky sport  SOFT_SERIAL_PIN_3 pour ESP01  SOFT_SERIAL_PIN_D6 pour NodeMCU
...
*/
//*********************** "000B01000000000000000000000000"  // 30 caractères
...
void beginServer()
{
  ...
  // pour OTA   ++++++++++++++++++++++++++++++++++++++++++++++++++++++
  server.on("/OTA_", HTTP_GET, []() {
    server.send_P(200, "text/html", pageOTA);
  });
